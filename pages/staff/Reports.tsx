...
import { Calendar, BarChart2, Users, AlertCircle, Clock, CheckCircle, School, ChevronDown, Loader2, Printer, PieChart as PieIcon, TrendingUp, ArrowUpRight } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        const classStats: Record<string, { name: string, absent: number, late: number, total: number }> = {};
        ...
        myRecords.forEach(record => {
            ...
            if (!classStats[classKey]) classStats[classKey] = { name: classKey, absent: 0, late: 0, total: 0 };
